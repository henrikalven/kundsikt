          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <SectionCard
                ...
                onEdit={(id, newTitle) => handleSectionChange('pains', editedPersona.pains.map(item => item.id === id ? { ...item, title: newTitle } : item))}
                onDelete={(id) => handleSectionChange('pains', editedPersona.pains.filter(item => item.id !== id))}
              ...
              <SectionCard
                ...
                onEdit={(id, newTitle) => handleSectionChange('gains', editedPersona.gains.map(item => item.id === id ? { ...item, title: newTitle } : item))}
                onDelete={(id) => handleSectionChange('gains', editedPersona.gains.filter(item => item.id !== id))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <SectionCard
                ...
                onEdit={(id, newTitle) => handleSectionChange('jobs', editedPersona.jobs.map(item => item.id === id ? { ...item, title: newTitle } : item))}
                onDelete={(id) => handleSectionChange('jobs', editedPersona.jobs.filter(item => item.id !== id))}
              ...
              <SectionCard
                ...
                onEdit={(id, newTitle) => handleSectionChange('whereToReach', editedPersona.whereToReach.map(item => item.id === id ? { ...item, title: newTitle } : item))}
                onDelete={(id) => handleSectionChange('whereToReach', editedPersona.whereToReach.filter(item => item.id !== id))}
